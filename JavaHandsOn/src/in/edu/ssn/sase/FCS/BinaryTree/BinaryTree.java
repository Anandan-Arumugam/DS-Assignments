...
public class BinaryTree {
	...
	public void postFixLoop(){
		...
		while(!nodes.isEmpty()) {
			...
			if(thisNode.getLeftBTree()==null && thisNode.getRightBTree()==null|| thisNode.getRightBTree()==lastAdded||thisNode.getLeftBTree()==lastAdded){
				output.add(thisNode);
				lastAdded=nodes.pop();
			}
			else if(thisNode.getLeftBTree()!=null){
				if(thisNode.getRightBTree()!=null){
